      ...
      <div className="flex max-lg:justify-between gap-[30px] w-full h-[65px] lg:px-[5%] lg:mt-[4%]">
         <nav className="flex max-lg:flex-col lg:justify-between max-lg:gap-[5%] p-[1.5%] w-[50%] h-[50vh] lg:w-[80%] lg:h-[75px] lg:rounded-full lg:items-center font-semibold bg-navbar border-[2px] border-[#E2E2E2] box-border">
            ...
            <div className="justify-between lg:gap-[30px] max-lg:h-full max-lg:px-[5%] flex max-lg:flex-col">
               <input className="max-lg:text-start" type="button" value={lang === "es" ? "HABILIDADES" : "SKILLS"} />
               <input className="max-lg:text-start" type="button" value={lang === "es" ? "SOBRE MI" : "ABOUT ME"} />
               <input className="max-lg:text-start" type="button" value={lang === "es" ? "PROYECTOS" : "PROJECTS"} />
               <input className="max-lg:text-start" type="button" value={lang === "es" ? "PROCESOS" : "PROCESSES"} />
               <select 
                  className="rounded-full w-fit bg-[#FFFFFF80] p-2 focus:outline-2 focus:outline-[#FFFFFF]" name="lang" id="lang"
